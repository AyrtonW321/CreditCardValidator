...
function checkCCDetails(ccNumber) {
    ...
    let firstDigitInfo = ['Airlines', 'Airlines', 'Travel and Entertainment', 'Banking and Financial', 'Banking and Financial', 'Merchandising and Banking', 'Petroleum', 'Healthcare and Telecommunications', 'National Assignment'];
